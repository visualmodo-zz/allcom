...
add_filter( 'comment_form_default_fields', 'allcom_bootstrap_comment_form_fields' );

if ( ! function_exists( 'allcom_bootstrap_comment_form_fields' ) ) {
	/**
	 ...
	 * @return array
	 */
	function allcom_bootstrap_comment_form_fields( $fields ) {
...
} // End of if function_exists( 'allcom_bootstrap_comment_form_fields' )

// Add Bootstrap classes to comment form submit button and comment field.
add_filter( 'comment_form_defaults', 'allcom_bootstrap_comment_form' );

if ( ! function_exists( 'allcom_bootstrap_comment_form' ) ) {
	/**
	 ...
	 * @return string[]
	 */
	function allcom_bootstrap_comment_form( $args ) {
		$replace = array(
			'<p class="' => '<div class="form-group ',
...
} // End of if function_exists( 'allcom_bootstrap_comment_form' ).


// Add note if comments are closed.
add_action( 'comment_form_comments_closed', 'allcom_comment_form_comments_closed' );

if ( ! function_exists( 'allcom_comment_form_comments_closed' ) ) {
	/**
	 * Displays a note that comments are closed if comments are closed and there are comments.
	 */
	function allcom_comment_form_comments_closed() {
		if ( get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) {
			?>
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'allcom' ); ?></p>
			<?php
		}
	}
} // End of if function_exists( 'allcom_comment_form_comments_closed' ).
